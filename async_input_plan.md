...
src/main.h - Add 1 field (mutex)
src/main.c - Add 4 lines total (init, destroy, 2 lock/unlock)
src/websocket/protocol/socketio.c - Add lock/unlock to 16 handler functions
...
File: src/main.h - After line 37 (after player_t player;)
...
File: src/main.c - After line 516 (after BarPlayerInit())
...
File: src/main.c - Delete lines 417-465
...
File: src/websocket/protocol/socketio.c
...
Line 1405 - BarSocketIoHandleAction()
Line 1457 - BarSocketIoHandleChangeStation()  
Line 1480 - BarSocketIoHandleSetQuickMix()
Line 1538 - BarSocketIoHandleDeleteStation()
Line 1621 - BarSocketIoHandleCreateStationFrom()
Line 1675 - BarSocketIoHandleQuery()
Line 705 - BarSocketIoHandleGetGenres()
Line 729 - BarSocketIoHandleAddGenre()
Line 772 - BarSocketIoHandleAddMusic()
Line 828 - BarSocketIoHandleRenameStation()
Line 886 - BarSocketIoHandleGetStationModes()
Line 968 - BarSocketIoHandleSetStationMode()
Line 1014 - BarSocketIoHandleGetStationInfo()
Line 1123 - BarSocketIoHandleDeleteSeed()
Line 1210 - BarSocketIoHandleDeleteFeedback()
Line 1339 - BarSocketIoHandleSearchMusic()
Step 7: Update BarSocketIoHandleAction
File: src/websocket/protocol/socketio.c - Line 1405
...
File: src/websocket/core/websocket.h - Line ~67
...
File: src/websocket/core/websocket.c
